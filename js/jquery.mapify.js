...
;(function($) {
    ...
    var mapifyElement = function(element, settings) {
        ...
        $.each(settings.points, function(i, point) {
            ...
            // Add street view if point has street view coordinates
            if (point.streetView) {
               var streetViewPosition = new google.maps.LatLng({
                 lat: point.streetView.lat,
                 lng: point.streetView.lng
             });

             var panorama = new google.maps.StreetViewPanorama(element, {
                position: streetViewPosition,
                pov: {
                    heading: point.streetView.heading || 0,
                    pitch: point.streetView.pitch || 0
                }
             });
    ...
    $.fn.mapify = function(options) {
        ...
        var apiKey = 'AIzaSyCthNHNmihmVx6BYurhLo5Z_2q3WlKnYlo';
          
        $.getScript('https://maps.googleapis.com/maps/api/js?key=' + apiKey + '&language=en', function() {
